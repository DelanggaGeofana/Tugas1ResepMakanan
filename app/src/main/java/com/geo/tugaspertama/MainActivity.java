...
public class MainActivity extends AppCompatActivity {
    ...
    private void prepareresepData() {
        resep Resep1 = new resep("SOTO AYAM",
        ...
        resep Resep2 = new resep("OPOR AYAM", "Opor ayam merupakan masakan yang sangat dikenal di Indonesia.\n" +
                "\" +\n" +
        ...
        resep Resep3 = new resep("AYAM GORENG", "Ayam goreng adalah hidangan yang dibuat dari daging ayam dicampur tepung bumbu yang digoreng dalam minyak goreng panas. \n" +
...
//
        resep Resep5 = new resep("NASI GORENG", "Nasi goreng adalah makanan yang umum di hidangkan di indonesia dengan bahan dasar nasi\n" + "yang di campur oleh bumbu dan sedikit kecap yang akan memberikan warna coklat", R.drawable.ns, "Ingredients :\n" +
                "2-3 piring nasi\n" +
                "2 buah telur\n" +
                "1 genggam kol iris\n" +
